...
Oaklab_GFX::        INCBIN "gfx/tilesets/oaklab.2bpp"
Oaklab_Block::      INCBIN "gfx/blocksets/oaklab.bst"
FarawayIsland_GFX::   INCBIN "gfx/tilesets/farawayisland.2bpp"
FarawayIsland_Block:: INCBIN "gfx/blocksets/farawayisland.bst"
