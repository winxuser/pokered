...
; Learnset
	db 7, STUN_SPORE
	db 13, POISONPOWDER ; dereknote TODO fix to 13?
	db 19, LEECH_LIFE
	db 28, SPORE
	db 37, SLASH
	db 46, GROWTH
...
PichuEvosMoves:
; Evolutions
	db EVOLVE_ITEM, THUNDER_STONE, 1, PIKACHU
	db 0
; Learnset
    db 6, TAIL_WHIP
	db 8, THUNDER_WAVE
...
CleffaEvosMoves:
; Evolutions
	db EVOLVE_ITEM, MOON_STONE, 1, CLEFAIRY
	db 0
; Learnset
    db 8, SING
	db 0
...
IgglybuffEvosMoves:
; Evolutions
	db EVOLVE_ITEM, MOON_STONE, 1, JIGGLYPUFF
	db 0
; Learnset
    db 4, DEFENSE_CURL
    db 9, POUND
...
TogepiEvosMoves:
; Evolutions
	db EVOLVE_ITEM, MOON_STONE, 1, TOGETIC
	db 0
; Learnset
    db 7, METRONOME
    db 38, DOUBLE_EDGE
