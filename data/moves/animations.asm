...
CrossChopAnim:
	battle_anim NO_MOVE, SE_SHAKE_SCREEN
	battle_anim NO_MOVE, SUBANIM_0_SLICE_BOTH_SIDES, 0, 8
	battle_anim NO_MOVE, SE_SHAKE_SCREEN
	db -1 ; end
...
MudSlapAnim:
	battle_anim BUBBLE, SUBANIM_0_WATER_BUBBLES, 0, 4
	db -1 ; end
...
SteelWingAnim:
	battle_anim NO_MOVE, SE_DARK_SCREEN_PALETTE
	battle_anim WING_ATTACK, SUBANIM_0_SLICE_BOTH_SIDES, 0, 8
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
...
MilkDrinkAnim:
	...
	battle_anim NO_MOVE, SE_DARK_SCREEN_FLASH
	battle_anim LEECH_LIFE, SUBANIM_0_CIRCLE_1_SQUARE_CLOSING, 1, 6
	db -1 ; end
