MapSongBanks::
	...
	db MUSIC_PALLET_TOWN, 0 ; YELLOWS_HOUSE UNUSED_MAP_69
	db MUSIC_PALLET_TOWN, 0 ; YELLOWS_HOUSE_2F UNUSED_MAP_6A
	db MUSIC_DUNGEON3, 0 ; ICE_CAVERN UNUSED_MAP_6B
	db MUSIC_DUNGEON3, 0 ; VICTORY_ROAD_1F
	db MUSIC_POKECENTER, 0 ; Pokecenter UNUSED_MAP_6D
	db MUSIC_DUNGEON3, 0 ; FARAWAY ISLAND OUTSIDE UNUSED_MAP_6E
	db MUSIC_DUNGEON3, 0 ; FARAWAY ISLAND INSIDE UNUSED_MAP_6F
	...
	db MUSIC_CELADON, BANK(Music_Celadon) ; TRADER_HOUSE
