...
InternalMapEntries:
	...
	indoor_map ICE_CAVERN,              6, 15, Route19Name
	indoor_map VICTORY_ROAD,            0,  4, VictoryRoadName
	indoor_map FARAWAY_ISLAND,          9, 15, FarawayIslandName
	...
	indoor_map CELADON_CITY_2,          7,  5, CeladonCityName
;	indoor_map ROCKET_HQ,               7,  5, RocketHQName ;removed this entry in order to fit TRADER_HOUSE (below) in the table
