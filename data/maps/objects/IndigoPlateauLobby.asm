...
IndigoPlateauLobby_Object:
	...
	warp_event 13,  0, LORELEIS_ROOM, 1

	def_bg_events

	def_object_events
	object_event  3,  5, SPRITE_NURSE, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_NURSE
	object_event  4,  9, SPRITE_GYM_GUIDE, STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_GYM_GUIDE
	object_event  9,  9, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_COOLTRAINER_F
	object_event 11,  5, SPRITE_CLERK, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_CLERK
	object_event 13,  7, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_LINK_RECEPTIONIST
