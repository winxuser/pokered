...
PewterCity_Object:
	...
	def_warp_events
	warp_event 13, 25, POKE_CENTER, 1
	...
	bg_event 24, 20, TEXT_PEWTERCITY_SIGN
	...
	object_event 31,  4, SPRITE_YOUNGSTER, WALK, LEFT_RIGHT, TEXT_PEWTERCITY_TRADER_TIPPER ; dereknote - Trader House tipper NPC
